...
client.on('messageDelete', message => {
  console.log(`a message saying "${message.cleanContent}" was deleted from channel: ${message.channel.name} at ${myDate()}`);
  client.channels.get("855551660175917116").send(`A message saying "***${message.cleanContent}***" + "***${message.author.id}***" + "***${message.author.username}***" has been deleted at ${myDate.toLocaleString()}`)
});
